...
function ImagesSwiper() {
  return (
    <ImagesContainer>
      ...
      >
        <SwiperSlide className='swiper-image'><img src={"assets/Julienne/1.png"} alt="slicer" /></SwiperSlide>
        <SwiperSlide className='swiper-image'><img src={"assets/Julienne/2.png"} alt="slicer"/></SwiperSlide>
        <SwiperSlide className='swiper-image'><img src={"assets/Julienne/3.png"} alt="slicer"/></SwiperSlide>
        <SwiperSlide className='swiper-image'><img src={"assets/Julienne/4.png"} alt="slicer"/></SwiperSlide>
